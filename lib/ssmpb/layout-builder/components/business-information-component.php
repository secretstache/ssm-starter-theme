...
<div<?php echo component_id_classes( $c_classes ); ?>>
  ...
  <?php $business_info = get_component_field('business_information'); ?>
  ...
  <?php $office_address = ssm_get_field('office_address', 'options'); ?>
  ...
  <?php $mailing_address = ssm_get_field('mailing_address', 'options'); ?>
  ...
  <?php $phone = ssm_get_field('primary_phone_number', 'options'); ?>
  <?php $email = ssm_get_field('primary_email_address', 'options'); ?>
  ...
  <div class="contact-info">
    ...
    <?php if ( $email ) { ?>
    <p clas="email">Email: <span itemprop="email"><a href="mailto:<?php echo $email; ?>"><?php echo $email; ?></a></span></p>
    <?php } ?>
  </div>
